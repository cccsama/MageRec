...
class GMambaBlock(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        # Conv1d，先转维度
        g1 = input_tensor.transpose(1, 2)        # [B, embed_dim, seq_len]
        g1 = self.conv1d(g1)                     # [B, embed_dim, seq_len]
        g1 = g1.transpose(1, 2)                  # [B, seq_len, embed_dim]
        
        # GRU 输入也应该是 [B, seq_len, embed_dim]
